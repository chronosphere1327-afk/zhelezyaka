...
<body class="min-h-screen" style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 50%, #020617 100%);">
    ...
    <div id="app" class="max-w-md mx-auto">
        ...
        <div class="desktop-bottom-bar">
            ...
            <button class="desktop-action-btn" onclick="makePhoneCall()">
        ...
        <div id="productDetailModal" class="product-detail-modal hidden">
            ...
            <div class="product-detail-content">
                ...
                <div class="product-detail-buttons">
                    <button onclick="makePhoneCall()" class="product-detail-btn">
    ...
    <script>
        ...
        function makePhoneCall() {
            const phoneNumber = CONTACT_INFO.phone.replace(/-/g, '');
        ...
        function renderFavorites() {
            ...
            favorites.forEach((fav, index) => {
                ...
                html += `
                    <div class="mt-3">
                        <button onclick="makePhoneCall()" class="w-full py-3 phone-button rounded-lg transition font-medium flex items-center justify-center">
    ...
    try {
        ...
        function renderBrigadeObjects(groupName, brigade) {
            ...
            html += `
                        <div class="space-y-3">
                            <button onclick="makePhoneCall()" class="w-full py-4 bg-green-500 text-white rounded-lg font-medium flex items-center justify-center text-lg">
